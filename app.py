...
client = OpenAI(base_url="http://54.179.242.249:8000/v1", api_key="lm-studio")
...
"""
    ...
    adjusted_sql_query = adjust_sql_for_sqlite(sql_query.replace('<｜end▁of▁sentence｜>', ''))

    expander = st.text_area("Suggestion", adjusted_sql_query)
